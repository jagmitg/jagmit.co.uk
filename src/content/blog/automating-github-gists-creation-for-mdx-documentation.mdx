...
date: '2024-12-28'
description: A practical guide demonstrating how to automate the creation of GitHub Gists from code blocks in MDX documentation using TypeScript and the GitHub API.
